...
1.  Remove multiple edges and loops. AKA simplifying the network.
...
```{r}
set.seed(123)                                       # The Louvain method is a randomised algorithm, 
                                                    # which aims to always maximise modularity. If the communities 
                                                    # are week, every time we run the algorithm the results might
                                                    # might be different. To avoid such inconsistency, we can add
                                                    # the set.seed() function. See what is does here:
