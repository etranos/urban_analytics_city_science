...
4.  [Network analysis practical](network_analysis.Rmd){target="_blank"}

5.  [Network analysis practical](network_analysis.Rmd){target="_blank"}
...
7.  [Diversity in cities](diversity.qmd){target="_blank"}
...
9.  Spatial interaction modelling
    ...
    You learned to analyse network, now you can learn to analyse and model flows. Do you see the parallel?
