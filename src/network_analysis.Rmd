...
save the .csv on your working directory under a `/data` directory and unzip it. We 
will use the:
...
on your hard drive and the point this location to `st_read()`.
...
Now that we understood how the above works, let's chain them together to create a
`centralities` tibble.
