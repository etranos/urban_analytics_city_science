...
-   These are some standard values based on past empirical studies
...
-   Look up properties of logarithms, e.g. [here](https://en.wikipedia.org/wiki/List_of_logarithmic_identities){target="_blank"}
...
-   $\lambda = 0.727$, coefficient for $(lnV_i)$

-   $\alpha = 0.464$, coefficient for $lnW_j$

-   $\beta = -0.624$, coefficient for $lnd_{ij}$
