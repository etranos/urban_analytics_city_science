...
::: columns
::: {.column width="50%"}
![](images/urban_population_diff.jpg)
:::

::: {.column width="50%"}
Even the definition of what is 'urban' can be different

@hanberry_imposing_2022
:::
:::
...
<!-- Marshallian externalities are the benefits obtained by a sector due to geographical agglomeration, -->

<!-- Jacobian effects are spillovers related to the novel combinations that can occur in cities with diversified economic activities. -->

## Agglomeration economies

<!-- explain the example on shopping centre -->

![](images/economies_agglomeration2.png) \## Agglomeration economies
...
<!-- Agglomeration economies can take the form of either “localization” economies (the benefits from colocation of similar producers) or “urbanization” economies (the benefits from conglomeration of diverse producers). -->

## Localization Economies

<!-- Localization economies arise from the presence of a large number of firms in the same industry in the same place.-->
...
![](images/nesta_clusters.png){width="50%"}
...
Bounded rationality [@simon1955behavioral; @simon1966theories] <!-- Human decision making is limited by cognitive strains. Time, information and cognitive abilities. People almost never know the full set of possibilities and make choices based on those possibilities they have available -->
...
-   Walter Christaller @brush_walter_1966
