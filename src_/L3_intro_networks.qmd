...
<!-- if raph has more than 2 nodes and odd number of links, single path cannot be found -->
...
## 1. Directed, non-weighted networks^[@hanneman2005introduction is a very useful [online source](http://faculty.ucr.edu/~hanneman/nettext/){target="_blank"} for most of the concepts presented here.]
...
<!-- <iframe src="http://schochastics.net/sna/periodic.html" width="1200" height="600" frameBorder="0" scrolling="yes"></iframe> -->

<!-- iframe doesn't work because of https/http mixed content -->

[![](images/periodic.png)](http://schochastics.net/sna/periodic.html)

<small><small> Source: [schochastics.net](http://schochastics.net/sna/periodic.html){target="_blank"} </small></small>
...
![](images/tranos_epb.png)
<small> Source: @tranos2015international </small>
