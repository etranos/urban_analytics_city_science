...
# This is the project path
path <- find_rstudio_root_file()
path.data <- paste0(path, "/Users/tk18583/Documents/UA_one for change/data/businesses-in-london.csv")
...
path.shape <- paste0(path, "/Users/tk18583/Documents/UA_one for change/data/Local_Authority_Districts_(May_2021)_UK_BFE.geojson")
